    ...
    <div className="Navbar_main_fixed">
      ...
      <div className="Navbar_second">
        <div className="menucontainer">
          ...
          <Link className="dropdown" to="/Brushes">Brushes</Link>
          <Link className="dropdown" to="/SkinCare">Skincare</Link>
          <Link className="dropdown" to="/Gifting">Gifting</Link>
          <Link className="dropdown" to="/">Blog</Link>
          <Link className="dropdown" to="/Offers">Offers</Link>
          <Link className="dropdown" to="/">
            Stores
          </Link>
          <Link className="dropdown" to="/">Diwali Gifting</Link>
        </div>
      </div>
    </div>
  );
